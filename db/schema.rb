...
ActiveRecord::Schema.define(:version => 20180816041504) do
  ...
  add_index "shares", ["camera_id"], :name => "index_shares_on_camera_id"
  add_index "shares", ["subscribe_id"], :name => "index_shares_on_subscribe_id"
